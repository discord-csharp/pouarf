...
namespace Pouarf.Helpers
{
    public class SampleData
    {
        ...
        public SampleData(IRepository repo, IUnitOfWork unitOfWork)
        {
            _repo = repo;
        ...
        public async Task CreateSampleData()
        {
            var people = new List<Person>()
            {
                new Person()
                {
                    FirstName = "Delilah", LastName = "Ezekiel", BirthDate = DateTimeOffset.Now,
                    StreetAddresses = new List<StreetAddress>()
                    {
                ...
                new Person()
                {
                    FirstName = "Aileen", LastName = "Shana", BirthDate = DateTimeOffset.Now,
                                        StreetAddresses = new List<StreetAddress>()
                    {
                ...
                new Person()
                {
                    FirstName = "James", LastName = "Nadine", BirthDate = DateTimeOffset.Now,
                                        StreetAddresses = new List<StreetAddress>()
                    {
